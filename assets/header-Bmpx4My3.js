const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/wiauth-CQSnwcWL.js","assets/main-Cx6eND33.js","assets/vendor-B2AETYxa.js","assets/init-BETm3AxJ.js","assets/firebase-03f_o6lD.js"])))=>i.map(i=>d[i]);
import{M as _,$ as o,g as m,_ as e,r as u,w as p}from"./main-Cx6eND33.js";import"./vendor-B2AETYxa.js";p({js:[()=>e(()=>import("./wiauth-CQSnwcWL.js"),__vite__mapDeps([0,1,2,3,4]))]});function d(a){_?.("Bienvenido "+a.nombre),o(".wiauth").html(`
    <div class="sesion">
