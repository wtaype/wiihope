import{$ as o}from"./jquery-DduPepyT.js";import{d}from"./init-CCltGlup.js";import{k as P,q as _,w as $,c as y,l as k,d as u,a as v,s as M,m as N,b as q}from"./firebase-pFKiuoCA.js";import{g as F,e as B,N as l,b as S,r as b,f as Y,a as T,s as x}from"./widev-DLeh02I3.js";import"./vendor-B2AETYxa.js";const H=()=>{let r=[],t=F("wiSmile"),h=null;window.addEventListener("wiFresh",i=>{t=i.detail,n()});const n=()=>{const i=o(".phrs");i.find(".phr_dinamica, .phr_add, .frases_empty").remove(),r.length&&i.find(".skc").remove(),r.length?r.forEach((a,s)=>{const e=t?.email===a.email,f=B(a.actualizado||a.creado).get(a.actualizado||a.creado,"DD/MM/YYYY");i.append(`
