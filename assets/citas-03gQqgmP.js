import{g as x,$ as t,w as $,d as h,N as n,a as O,r as S,c as G,s as F}from"./main-4OUWmeHf.js";import{n as H,q as D,w as T,f as N,p as A,d as y,b as C,s as K,r as R,e as U}from"./firebase-JzOrHdc0.js";import"./main-DTV8JQEq.js";import"./vendor-B2AETYxa.js";const W=()=>{const f="wiFrases";let c=[],d=[],b=0,l=x("wiSmile"),p=[],z=5,u=!1;const B=4,g=8;t("#citas").html(`
    <div class="wicitas">
      ...
      <div class="citas_ctrl">
        ...
        <div class="citas_filtros">
          ...
          <button class="citas_add" style="display:${l?.email?"inline-flex":"none"}"><i class="fas fa-plus"></i> Nuevo</button>
        </div>
      </div>
  ...
  `);const L=s=>s.charAt(0).toUpperCase()+s.slice(1).toLowerCase(),w=()=>{const s=u?p.length:z,i=p.slice(0,s);t(".categorias_list").html(`
