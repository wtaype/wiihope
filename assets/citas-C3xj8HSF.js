import{g as _,$ as s,e as E,N as t,c as w,r as u,f as C,a as D,s as z}from"./main-D09d4m-p.js";import{d as c}from"./init-DcKKffQQ.js";import{k as B,q as M,l as N,c as P,m as $,d as m,a as f,s as q,n as Y}from"./firebase-B8KvrrVe.js";import"./main-C2SJPPNI.js";import"./vendor-B2AETYxa.js";const j=()=>{let l=[],r=_("wiSmile"),v=null;window.addEventListener("wiFresh",i=>{r=i.detail,d()});const d=()=>{const i=s(".phrs");i.find(".phr_dinamica, .phr_add, .frases_empty").remove(),l.length?l.forEach((a,o)=>{const e=r?.email===a.email,p=E(a.actualizado||a.creado).get(a.actualizado||a.creado,"DD/MM/YYYY");i.append(`
