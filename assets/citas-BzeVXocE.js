import{$ as o}from"./jquery-DduPepyT.js";import{d}from"./firebase-BQjYPACt.js";import{k as P,q as _,w as $,c as y,l as k,d as u,a as v,s as M,m as N,b as q}from"./firebase-pFKiuoCA.js";import{g as F,e as B,N as l,b as S,r as b,f as Y,a as T,s as x}from"./widev-DLeh02I3.js";import"./vendor-B2AETYxa.js";import"./wii-Ca5rm7MF.js";const I=()=>{let r=[],t=F("wiSmile"),h=null;window.addEventListener("wiFresh",i=>{t=i.detail,n()});const n=()=>{const i=o(".phrs");i.find(".phr_dinamica, .phr_add, .frases_empty").remove(),r.length&&i.find(".skc").remove(),r.length?r.forEach((a,s)=>{const e=t?.email===a.email,f=B(a.actualizado||a.creado).get(a.actualizado||a.creado,"DD/MM/YYYY");i.append(`
    ...
    `),T("mdFrase"),o(".md-cita").focus()},E=async function(){const i=o(".md-cita").val().trim(),a=o(".md-libro").val().trim(),s=o(".md-nombreShow").val().trim(),e=parseInt(o(".md-orden").val())||r.length+1,f=o("#md-favorito").is(":checked"),c=o("#md-publico").is(":checked"),m=o(this).data("id");if(!i||!a||!s)return l("Completa todos los campos","warning");if(i.length>500)return l("Cita muy larga (máx. 500)","warning");try{S(this,!0);const p={cita:i,libro:a,nombreShow:s,orden:e,favorito:f,publico:c,usuario:t.usuario||t.email.split("@")[0],email:t.email};m?(await k(u(d,"wicitas",m),{...p,actualizado:v()}),l("Frase actualizada","success")):(await M(u(d,"wicitas",`cita_${Date.now()}`),{...p,creado:v(),actualizado:v()}),l("Frase agregada","success")),b("wiFrases"),Y()}catch(p){console.error(p),l("Error al guardar","error")}finally{S(this,!1)}},C=async function(i){i.stopPropagation();const a=o(this).data("id"),s=r.find(e=>e.id===a);if(!s||t?.email!==s.email)return l("Sin permisos","warning");try{const e=!s.favorito;o(this).toggleClass("active").closest(".phr").toggleClass("favorito"),await k(u(d,"wicitas",a),{favorito:e,actualizado:v()}),b("wiFrases")}catch(e){console.error(e),l("Error al actualizar","error"),o(this).toggleClass("active").closest(".phr").toggleClass("favorito")}},D=function(i){i.stopPropagation();const a=r.find(s=>s.id===o(this).data("id"));!a||t?.email!==a.email?l("Sin permisos","warning"):g(o(this).data("id"))},z=async function(i){i.stopPropagation();const a=o(this).data("id"),s=r.find(e=>e.id===a);if(!s||t?.email!==s.email)return l("Sin permisos","warning");if(confirm(`¿Eliminar "${s.libro}"?`))try{await N(u(d,"wicitas",a)),o(this).closest(".phr").fadeOut(300,function(){o(this).remove()}),b("wiFrases"),l("Frase eliminada","success")}catch(e){console.error(e),l("Error al eliminar","error")}};o(document).on("click",".md_guardar",E).on("click",".btn_favorito",C).on("click",".btn_editar",D).on("click",".btn_eliminar",z).on("click",".phr_add",()=>g());const w=F("wiFrases");return w&&(r=w,n()),h=P(_(y(d,"wicitas"),$("publico","==",!0)),i=>{const a=i.docs.map(s=>({id:s.id,...s.data()}));t?.email?q(_(y(d,"wicitas"),$("email","==",t.email))).then(s=>{const e=s.docs.map(c=>({id:c.id,...c.data()}));r=[...a.filter(c=>c.email!==t.email),...e].sort((c,m)=>m.favorito-c.favorito||(c.orden||0)-(m.orden||0)),x("wiFrases",r),n()}):(r=a.sort((s,e)=>e.favorito-s.favorito||(s.orden||0)-(e.orden||0)),x("wiFrases",r),n())},i=>{console.error(i),l("Cargando desde caché","info")}),()=>{h?.(),window.removeEventListener("wiFresh",n),o(document).off("click",".md_guardar").off("click",".btn_favorito").off("click",".btn_editar").off("click",".btn_eliminar").off("click",".phr_add"),o("#mdFrase").remove(),console.log("📖 Citas limpiado")}};export{I as wiCitas};
