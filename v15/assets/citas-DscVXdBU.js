import{g as _,$ as s,a as E,N as t,b as w,r as u,c as C,d as D,s as z}from"./main-VibjpwTS.js";import{d as c}from"./init-BETm3AxJ.js";import{o as B,q as M,a as N,c as P,u as $,d as m,s as f,b as q,e as Y}from"./firebase-03f_o6lD.js";import"./vendor-B2AETYxa.js";const O=()=>{let l=[],r=_("wiSmile"),v=null;window.addEventListener("wiFresh",i=>{r=i.detail,d()});const d=()=>{const i=s(".phrs");i.find(".phr_dinamica, .phr_add, .frases_empty").remove(),l.length?l.forEach((a,o)=>{const e=r?.email===a.email,p=E(a.actualizado||a.creado).get(a.actualizado||a.creado,"DD/MM/YYYY");i.append(`
