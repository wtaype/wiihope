import{$ as t}from"./main-CypImdDN.js";import"./main-B_B97cYP.js";import"./vendor-B2AETYxa.js";import"./firebase-JzOrHdc0.js";const s=async()=>`
    <div class="wi404">
  ...
  `,r=()=>{t("#wi404-styles").length||t("head").append(`<style id="wi404-styles">
...
@keyframes glitch{0%,100%{transform:translate(0)}25%{transform:translate(-2px,2px)}75%{transform:translate(2px,-2px)}}
    </style>`),t(".wi404_btn").on("click",()=>location.href="/")};export{r as init,s as render};
